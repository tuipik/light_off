...
- При блокуванні сервіс проходить recovery ladder: `HTTP prefetch -> Playwright headless -> fresh browser process -> headful через xvfb` і лише потім переходить у backoff.
